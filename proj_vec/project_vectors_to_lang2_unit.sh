...
# Project embeddings with isometric constraint
# Argument:
...
#
# Example usage
# sh project_vectors_to_lang2_unit.sh Spanish.vec English.vec es-en.pair 10 projection Spanish.unit.proj English.unit.proj 0
